...
<body class="body-bg min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0" style="font-family:'Lato',sans-serif;">
    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        ...
        <section class="mt-10">
            <form class="flex flex-col" method="POST" action="includes/login.inc.php">
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <button class="bg-softBlue hover:bg-softBlue-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit" name="submit">Login</button>
            </form>
        </section>
    </main>
